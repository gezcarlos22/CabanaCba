...
const footer = () => {
  ...
  return (
    <div className='bg-black' id='first-section'>
      <div className='container mx-auto max-w-2xl pt-16 lg:pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8'>
        <div className='grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8'>
          ...
          {footerlinks.map((item, i) => (
            <div key={i} className='group relative col-span-2'>
              ...
              <ul className='flex flex-col gap-4 lg:gap-10 md:flex-row'>
            ...
            <div>
              <p className='text-center md:text-start text-white text-lg'>
                ...
                <Link
                  ...
                  target='_blank'
                  className='text-primary hover:text-white/60 hover:underline'>
                  {' '}
                  cabañacba.com
                </Link>
              </p>
